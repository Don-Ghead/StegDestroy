...
public:
	...
	*************************************************/
	...
	// [0-100] += 10
	bool jpg_write_images();

	//this will write the images to disk as they are if the bool is false
	//or will return to their original format before writing out if true.
	int write_image(bool return_to_orig_format);
